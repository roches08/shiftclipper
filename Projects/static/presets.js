  ...
  const VIDEO_TYPE_PRESETS = {
    wide_single_cam_working_v1: {
      ...
      values: {
        ...
        score_lock_threshold: 0.5,
        score_unlock_threshold: 0.44,
        lock_threshold_normal: 0.56,
        lock_threshold_reacquire: 0.36,
        lock_threshold_seed: 0.32,
        lost_timeout: 8,
        locked_grace_seconds: 0.75,
        lock_seconds_after_confirm: 4,
        reacquire_window_seconds: 14,
        reacquire_score_lock_threshold: 0.34,
        reacquire_max_sec: 2,
        loss_timeout_sec: 1.5,
        gap_merge_seconds: 0.5,
