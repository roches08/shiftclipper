...
def normalize_setup(payload: Dict[str, Any] | None) -> Dict[str, Any]:
    ...
    setup = {
        ...
        "yolo_batch": max(1, _as_int(src, "yolo_batch", 1)),
        ...
        "seed_min_iou": _as_float(src, "seed_min_iou", 0.15),
        "seed_dist_max": _as_float(src, "seed_dist_max", 0.18),
        "seed_bonus": _as_float(src, "seed_bonus", 0.20),
        "seed_search_window_seconds": _as_float(src, "seed_search_window_seconds", 2.5),
