...
def normalize_setup(payload: Dict[str, Any] | None) -> Dict[str, Any]:
    ...
    setup = {
        ...
        "seed_window_s": _as_float(src, "seed_window_s", _as_float(src, "seed_search_window_seconds", 45.0)),
        ...
        "export_seed_clips": bool(src.get("export_seed_clips", src.get("allow_seed_clips", False))),
        "allow_seed_clips": bool(src.get("allow_seed_clips", src.get("export_seed_clips", False))),
        ...
        "transcode_enabled": bool(src.get("transcode_enabled", False)),
        "transcode_preset": str(src.get("transcode_preset") or "tracking_mezzanine"),
        "transcode_crf": max(12, min(35, _as_int(src, "transcode_crf", 20))),
        "transcode_fps": None if src.get("transcode_fps") in (None, "") else max(1, _as_int(src, "transcode_fps", 30)),
        "transcode_scale_max": max(360, _as_int(src, "transcode_scale_max", 1080)),
        "transcode_denoise": bool(src.get("transcode_denoise", False)),
        "transcode_deinterlace": bool(src.get("transcode_deinterlace", True)),
        ...
        "reid_min_px": max(1, _as_int(src, "reid_min_px", 12)),
